...
var main_scene = function* (view) {
  ...
  yield* all(
    backdrop1().fill(GREEN, 0.6, easeInOutCubic, Color.createLerp("lab")),
    backdrop1().size.x("60%", 0.6),
    title2().text("CONTENT", 0.6),
  );
  ...
  yield* all(
    backdrop1().fill(BLUE, 0.6, easeInOutCubic, Color.createLerp("lab")),
    backdrop1().size.x("70%", 0.6),
    title2().text("ANIMATION", 0.6),
    rotationScale4(1, 0.6),
  );
  yield* beginSlide("animation");
  yield* all(
    backdrop1().fill(YELLOW, 0.6, easeInOutCubic, Color.createLerp("lab")),
    backdrop1().size.x("50%", 0.6),
    title2().text("FINISH", 0.6),
    rotationScale4(0, 0.6),
  );
  cancel(loopTask5);
